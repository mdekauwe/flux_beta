...
class FitFluxnetBeta(object):
    ...
    def main(self, rooting_depth):
        ...
        for fname in glob.glob(os.path.join(self.flux_dir,
            ...
            (ppt, et, sw) = self.estimate_soil_water_bucket(df, rooting_depth)
        ...
        fitMe(df, site, x_range, rooting_depth, to_screen=False)

    def estimate_soil_water_bucket(self, df, rooting_depth):
